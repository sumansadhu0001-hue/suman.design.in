...
import { Check, HelpCircle, Plus, Minus, ShieldCheck, Sparkles } from "lucide-react";
...
export default function Pricing({ setActivePage }: PricingProps) {
  ...
  return (
    <section
      id="pricing"
      className="py-12 sm:py-24 bg-[#f5f5f7] dark:bg-[#09090b] transition-colors duration-300 relative overflow-hidden"
    >
              ...
              <div className="relative z-10">
                ...
                <ul className="space-y-3.5 text-left mb-8">
                  {plan.features.map((feat, idx) => (
                    <li key={idx} className="flex items-start gap-3 text-xs leading-normal text-zinc-650 dark:text-zinc-300">
